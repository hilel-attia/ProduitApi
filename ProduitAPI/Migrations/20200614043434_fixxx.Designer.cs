...
namespace ProduitAPI.Migrations
{
    ...
    [Migration("20200614043434_fixxx")]
    partial class fixxx
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProduitAPI.Models.FactureFrs", b =>
                {
                    b.Property<Guid>("IdFac")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("DroitTimbre");

                    b.Property<string>("EtatFac");

                    b.Property<double>("MinTnet");

                    b.Property<double>("Mnthtva");
            ...
            modelBuilder.Entity("ProduitAPI.Models.LigneFactureFrs", b =>
                {
                    b.Property<Guid>("IdLi")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("IdFac");

                    b.Property<double>("NumCMD");

                    b.Property<double>("Puttcnet");

                    b.Property<double>("Qte");

                    b.Property<double>("Taux_tva");

                    b.HasKey("IdLi");

                    b.HasIndex("IdFac");

                    b.ToTable("LigneFactureFrs");
                });
            ...
            modelBuilder.Entity("ProduitAPI.Models.Commande_frs", b =>
                {
                    ...
                    b.HasOne("ProduitAPI.Models.FactureFrs", "FactureFrs")
                        .WithOne("Commande_frs")
                        .HasForeignKey("ProduitAPI.Models.Commande_frs", "IdFac")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ProduitAPI.Models.Fournisseur", b =>
                {
                    b.HasOne("ProduitAPI.Models.FactureFrs", "FactureFrs")
                        .WithOne("Fournisseur")
                        .HasForeignKey("ProduitAPI.Models.Fournisseur", "IdFO")
                        .OnDelete(DeleteBehavior.Cascade);
                });
